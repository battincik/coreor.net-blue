...
const projects = [
  ...
  },
  {
    ...
    desc: "A high-performance e-commerce platform built for a fashion retailer. Handles flash sales with 10,000 concurrent users, advanced search, and ML-powered recommendations.",
    impact: ["10K concurrent users", "320% conversion uplift", "Black Friday tested"],
    year: "2023",
    color: "from-sky-500/20 to-blue-500/10",
  },
  {
    title: "SecureShield Platform",
    category: "Cloud" as Category,
    tags: ["Go", "Docker", "PostgreSQL", "React"],
    desc: "A SaaS cybersecurity management platform that aggregates vulnerability scans, tracks remediation workflows, and provides executive risk scoring for enterprise security teams.",
    impact: ["500+ companies secured", "CVE tracking in real-time", "SOC2 certified"],
    year: "2024",
  ...
  },
  {
    ...
    category: "AI" as Category,
    tags: ["Python", "React Native", "GraphQL", "ML"],
    desc: "Route optimization and predictive maintenance platform for a fleet of 2,000 vehicles. ML models predict breakdowns 72 hours in advance, reducing downtime by 45%.",
    impact: ["2,000 vehicles managed", "45% less downtime", "30% fuel savings"],
    year: "2024",
    color: "from-cyan-500/20 to-sky-500/10",
  },
  {
    ...
    desc: "A property discovery and management platform featuring interactive maps, AI-powered valuation, virtual tours, and a CRM for real estate agents across three countries.",
    impact: ["12,000 active listings", "3 countries", "AI valuations in <2s"],
    year: "2022",
      ...
      <section className="relative pt-32 pb-16 text-center">
        ...
        <div className="relative max-w-4xl mx-auto px-6">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            A selection of projects that showcase our range, technical depth, and real-world impact.
          </p>
        </div>
      </section>
            ...
            {filtered.map((p, i) => (
              <RevealSection key={p.title} delay={i * 80}>
                <div className="glow-card rounded-xl overflow-hidden bg-card h-full flex flex-col">
                  {/* Gradient banner */}
                  <div className={`h-28 bg-gradient-to-br ${p.color} relative flex items-end p-5`}>
                    <div className="absolute inset-0 grid-bg opacity-40" />
                    <div className="relative">
                      <Badge variant="outline" className="text-xs border-border/60 bg-card/40 text-foreground/80 mb-1">
                        {p.category}
                      </Badge>
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="border-t border-border/50 pt-4">
                      <div className="text-xs text-muted-foreground uppercase tracking-widest mb-2 font-medium">Impact</div>
      ...
      <section className="py-20 bg-card/20 border-t border-border/30 text-center relative">
        ...
        <div className="relative max-w-2xl mx-auto px-6">
          <RevealSection>
            ...
            <p className="text-muted-foreground mb-8">Let's discuss how we can build something remarkable together.</p>
            <Button size="lg" onClick={() => navigate("contact")} className="btn-glow bg-primary text-primary-foreground font-semibold">
